...
# kgcn_parser.add_argument('--batch_size', type=int, default=batch_size, help='batch size')
...
kgcn_parser.add_argument('--dataset', type=str, default=DATASET, help='which dataset to use')
kgcn_parser.add_argument('--aggregator', type=str, default='sum', help='which aggregator to use')
kgcn_parser.add_argument('--n_epochs', type=int, default=40, help='the number of epochs')
kgcn_parser.add_argument('--neighbor_sample_size', type=int, default=16, help='the number of neighbors to be sampled')
kgcn_parser.add_argument('--dim', type=int, default=64, help='dimension of user and entity embeddings')
kgcn_parser.add_argument('--n_iter', type=int, default=1, help='number of iterations when computing entity representation')
kgcn_parser.add_argument('--batch_size', type=int, default=batch_size, help='batch size')
kgcn_parser.add_argument('--l2_weight', type=float, default=0.01, help='weight of l2 regularization')
kgcn_parser.add_argument('--lr', type=float, default=0.00001, help='learning rate')
kgcn_parser.add_argument('--ratio', type=float, default=1, help='size of training dataset')
